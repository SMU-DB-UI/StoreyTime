...
db.setupDB = function(result)
{
    ...
    connection.query("CREATE TABLE IF NOT EXISTS `groups_admins`(`group_id` INT(10), `admin_id` INT(10), `current` TINYINT, PRIMARY KEY(`group_id`, `admin_id`), FOREIGN KEY(`group_id`) REFERNCES `groups`(`group_id`), FOREIGN KEY(`admin_id`) REFERENCES `users`(`id`));")
