...
db.setupDB = function(result)
{
    ...
    connection.query("CREATE TABLE IF NOT EXISTS `group_members_bridge`(`group_id` INT(10),`member_id` INT(10), `removed` TINYINT, PRIMARY KEY(`group_id`, `member_id`),FOREIGN KEY(`group_id`) REFERENCES `groups`(`group_id`), FOREIGN KEY(`member_id`) REFERENCES `users`(`id`) );");
