...
db.setupDB = function(result)
{
    ...
    connection.query("CREATE TABLE IF NOT EXISTS `politicians`(`user_id` INT(10), `politician_type` VARCHAR(50), `office_phone` INT(11), `office_email` VARCHAR(50), `inactive` TINYINT(1), PRIMARY KEY(`user_id`), FOREIGN KEY(`user_id`) REFERENCES `users`(`id`));");
